...
Function sortbylength {Get-ChildItem | Sort-Object -Property Length -Descending} 		# Sort by length														
...
Function c {code .} 		# open current dir in vs code
...
Set-Alias tf "C:\Users\Public\Desktop\OTHER SOFTWARE\Terraform\1.9.5\terraform.exe"
Set-Alias terraform "C:\Users\Public\Desktop\OTHER SOFTWARE\Terraform\1.9.5\terraform.exe"
...
# Function cdHLGit {cd "C:\Users\hsabhosa\Downloads\HLGit"}
Function cdDotfiles {cd "E:\WORK\PROJECT\DotfilesWindows\"}
Function cdProject {cd "E:\WORK\PROJECT\git\"}
Function cdPersonalAssistant {cd "E:\WORK\PROJECT\git\PersonalAssistant"}
...
Function gitRefresh {
    param (
        [string]$InputBranch = 'main'   # default branch here
    )
    ...
    Write-Host "git pull origin $InputBranch :"
...
function gitPushNewBranch {
    ...
    Write-Host "`n...Committing changes with message '$commitMessage'..."
    ...
    Write-Host "`n...Pushing branch '$branchName' to remote ..."
...
Function pycli {
    cd "E:\WORK\PROJECT\git\PersonalAssistant\"
    
    # ; Run the Python CLI module in a new process so it doesn't block execution
    # Run, python -m UI.cli
    python -m UI.cli
